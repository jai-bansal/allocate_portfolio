...
# COMPUTE NEW ALLOCATION OF SHARES AFTER ADDING ADDITIONAL FUNDS ----------
  ...
  portfolio$current_percentage = round(100 * portfolio$current_equity / sum(portfolio$current_equity), 2)
  portfolio$ideal_percentage = round(100 * portfolio$ideal_equity / sum(portfolio$ideal_equity), 2)
